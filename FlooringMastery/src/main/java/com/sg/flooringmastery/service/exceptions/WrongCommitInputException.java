 ...
 * @author tedis
 */
public class WrongCommitInputException extends Exception {
    ...
    public WrongCommitInputException(String message) {
    ...
    public WrongCommitInputException(String message, Throwable cause) {
        super(message, cause);
    }
}
