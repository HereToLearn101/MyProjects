 ...
 * @author tedis
 */
public class CustomerNameInputException extends Exception {
    ...
    public CustomerNameInputException(String message) {
    ...
    public CustomerNameInputException(String message, Throwable cause) {
        super(message, cause);
    }
}
