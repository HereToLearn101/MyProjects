 ...
 * @author tedis
 */
public class OrderNumberInputException extends Exception {
    ...
    public OrderNumberInputException(String message) {
    ...
    public OrderNumberInputException(String message, Throwable cause) {
        super(message, cause);
    }
}
