...
public class Order {
    ...
    private BigDecimal taxRate; // associated with state
    private String productType;
    private BigDecimal area;
    private BigDecimal costPerSquareFoot; // associated with productType
    private BigDecimal laborCostPerSquareFoot; // associated with productType
